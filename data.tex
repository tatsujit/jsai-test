...
\begin{abstract}
Here is abstract (max. 150 words) in English. 
This file is a template file for the XXth annual conference of
JSAI for \LaTeX{}. 
This is also a sample of the formatted manuscripts.
And this document describes a formatting guideline for (Japanese)
manuscripts 
of the XXth annual conference of JSAI. 
%%This is also a sample of the formatted manuscripts.
\end{abstract}
...
全国大会論文集は電子的にご提出頂くファイルをそのまま収録した CD-ROM で
す．この手引きをご参照の上，原稿をお作り頂きますようお願いします．この
手引きは \LaTeX 用スタイルファイルの使い方を説明したもので，これ自体も
サンプルとなっています．
